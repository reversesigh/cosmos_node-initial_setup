...
It's time to edit `app.toml` if you need to enable, disable, or edit ports for LCD and gRPC. Also be mindful of minimum gas fees, especially if you are a valiadtor. Refer to official docs for more information. To get started open the `app.toml` file.   
